...
%-----------------------------------------------------------  
  ...
  +86-18626423381 \\
  jhhuang\_nuaa@126.com, huangjunhao@uic.edu.cn \\
...
\begin{enumerate}\setlength{\itemsep}{0pt}
	...
	In \textcolor{blue}{IACR Transactions on Cryptographic Hardware and Embedded Systems, Volume 2024, Issue 2.} (\textbf{CCF-B})
	}

	\item {Research on Efficient Implementation of SM2 for Mobile Devices.\\ 
	Jipeng Zhang, \textbf{Junhao Huang}, Xuan Yu, Zhe Liu*. \\ 
	In \textcolor{blue}{Acta Electronica Sinica.}
	}
	...
	In \textcolor{blue}{IACR Transactions on Cryptographic Hardware and Embedded Systems, Volume 2022, Issue 4.} (\textbf{CCF-B})
	}
