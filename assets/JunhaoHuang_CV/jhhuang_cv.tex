...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
\item Lattice-based Cryptography, Fully Homomorphic Encryption, ARM, RISC-V.% instruction set design.
\end{itemize}
...
\item \projectsubheading{Research on Software/Hardware Co-design of Computing Platform for Lattice-Based Cryptosystems}{National Nature Science Fund of China}{2021-2023}{Main participant}{Proposed an improved Plantard arithmetic for efficient lattice-based cryptographic implementation}{One publication in IACR TCHES 2022}{}
\end{itemize}
...
\begin{enumerate}\setlength{\itemsep}{0pt}
	...
	\item {\textbf{Prof. \c{C}etin Kaya Ko\c{c}}: IEEE Life Fellow, Co-founder of CHES, Professor of University of California Santa Barbara, cetinkoc@ucsb.edu}
	% \item {\textbf{Prof. Ray C.C. Cheung}: Associate Provost, Professor of City University of Hong Kong, Associate Provost (Digital Learning)}
\end{enumerate}
