...
%   Beijing Normal-Hong Kong Baptist University (BNBU)  \\
  ...
  Postal Address: 2000 Jintong Road, Tangjiawan, Zhuhai, Guangdong Province, China\\
  Postal code: 519087
\end{tabular*}
\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
\item Modular Arithmetic, Lattice-based Cryptography, Fully Homomorphic Encryption, ARM \& RISC-V.
\end{itemize}
