...
\newcommand{\resheading}[1]{\vspace{2pt}%{\vspace{8pt}
...
\begin{enumerate}\setlength{\itemsep}{0pt}
	...
	In \textcolor{blue}{IEEE Transactions on Information Forensics \& Security, 2024.} (\textbf{CCF-A \& SCI I})
	}
	...
	In \textcolor{blue}{IACR Transactions on Cryptographic Hardware and Embedded Systems, 2024.} (\textbf{CCF-B \& Top-tier conference in cryptography})
	}
	...
	In \textcolor{blue}{IACR Transactions on Cryptographic Hardware and Embedded Systems, 2022.} (\textbf{CCF-B \& Top-tier conference in cryptography})
	}
	...
	In \textcolor{blue}{Usenix Security, 2024.} (\textbf{CCF-A \& Top-tier conference in security \& Distinguished Paper Award})
	}
