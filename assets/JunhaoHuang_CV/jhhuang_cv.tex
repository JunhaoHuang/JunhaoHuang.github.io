...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
\item Lattice-based Cryptography, Privacy-preserving AI, ARM, RISC-V instruction set design.
\end{itemize}
...
\begin{enumerate}\setlength{\itemsep}{0pt}
	\item {\textbf{Junhao Huang}, Jipeng Zhang, Weijia Wang, Xuan Yu, Donglong Chen*}, {Efficient High-order Masking Raccoon on ARM Cortex-M4[J]}. ({\bf Submitted to IACR Transactions on Cryptographic Hardware and Embedded Systems 2025})
	\item {
		{Zewen Ye, \textbf{Junhao Huang}, Tianshun Huang, Yudan Bai, Jinze Li, Hao Zhang, Guangyan Li, Donglong Chen, Ray CC Cheung, Kejie Huang}, {PQNTRU: Acceleration of NTRU-based Schemes via Customized Post-Quantum Processor[J]}. ({\bf Submitted to IEEE Transactions on Computers 2025})
	}
	\item {Haosong Zhao, \textbf{Junhao Huang}, Zihang Chen, Kunxiong Zhu, Donglong Chen, Zhuoran Ji, Hongyuan Liu}, {VESTA: A Secure and Efficient FHE-based Three-Party {V}ectorized {E}valuation {S}ystem for {T}ree {A}ggregation Models[C]}. \textit{ACM SIGMETRICS 2025 (To appear)} ({\bf CCF-B \& Top-tier conference in computer systems})
...
\begin{enumerate}\setlength{\itemsep}{0pt}
	...
	% \item {\textbf{Prof. Ray C.C. Cheung}: Professor, Associate Provost of City University of Hong Kong, r.cheung@cityu.edu.hk}
